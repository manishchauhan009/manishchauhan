...
const MOCK_BLOGS = [
    {
        ...
        description: "Exploring how AI agents are transforming the way we build and interact with web applications.",
    ...
    },
    {
        ...
        description: "A deep dive into server actions, caching strategies, and performance optimization in Next.js 14.",
        image_url: "https://images.unsplash.com/photo-1618477247222-ac59124545da?w=800&q=80",
    ...
    },
    {
        ...
        description: "Why dark mode is more than just inverted colors. Tips for creating accessible and beautiful dark themes.",
    ...
    useEffect(() => {
        const fetchBlogs = async () => {
            try {
                ...
                // Use mocks if no real blogs or to fill the grid
                const finalBlogs = realBlogs.length > 0 ? realBlogs : MOCK_BLOGS;
                setBlogs(finalBlogs);
            } catch (error) {
